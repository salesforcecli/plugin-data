...
_See code: [src/commands/data/create/record.ts](https://github.com/salesforcecli/plugin-data/blob/2.6.2/src/commands/data/create/record.ts)_
...
_See code: [src/commands/data/delete/bulk.ts](https://github.com/salesforcecli/plugin-data/blob/2.6.2/src/commands/data/delete/bulk.ts)_
...
_See code: [src/commands/data/delete/record.ts](https://github.com/salesforcecli/plugin-data/blob/2.6.2/src/commands/data/delete/record.ts)_
...
_See code: [src/commands/data/delete/resume.ts](https://github.com/salesforcecli/plugin-data/blob/2.6.2/src/commands/data/delete/resume.ts)_
...
_See code: [src/commands/data/export/tree.ts](https://github.com/salesforcecli/plugin-data/blob/2.6.2/src/commands/data/export/tree.ts)_
...
_See code: [src/commands/data/get/record.ts](https://github.com/salesforcecli/plugin-data/blob/2.6.2/src/commands/data/get/record.ts)_
...
_See code: [src/commands/data/import/tree.ts](https://github.com/salesforcecli/plugin-data/blob/2.6.2/src/commands/data/import/tree.ts)_
...
_See code: [src/commands/data/query.ts](https://github.com/salesforcecli/plugin-data/blob/2.6.2/src/commands/data/query.ts)_
...
_See code: [src/commands/data/query/resume.ts](https://github.com/salesforcecli/plugin-data/blob/2.6.2/src/commands/data/query/resume.ts)_
...
_See code: [src/commands/data/resume.ts](https://github.com/salesforcecli/plugin-data/blob/2.6.2/src/commands/data/resume.ts)_
...
_See code: [src/commands/data/update/record.ts](https://github.com/salesforcecli/plugin-data/blob/2.6.2/src/commands/data/update/record.ts)_
...
_See code: [src/commands/data/upsert/bulk.ts](https://github.com/salesforcecli/plugin-data/blob/2.6.2/src/commands/data/upsert/bulk.ts)_
...
_See code: [src/commands/data/upsert/resume.ts](https://github.com/salesforcecli/plugin-data/blob/2.6.2/src/commands/data/upsert/resume.ts)_
...
_See code: [src/commands/force/data/bulk/delete.ts](https://github.com/salesforcecli/plugin-data/blob/2.6.2/src/commands/force/data/bulk/delete.ts)_
...
_See code: [src/commands/force/data/bulk/status.ts](https://github.com/salesforcecli/plugin-data/blob/2.6.2/src/commands/force/data/bulk/status.ts)_
...
_See code: [src/commands/force/data/bulk/upsert.ts](https://github.com/salesforcecli/plugin-data/blob/2.6.2/src/commands/force/data/bulk/upsert.ts)_
